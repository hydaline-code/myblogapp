...
RSpec.describe Post, type: :model do
  describe 'validations' do
    it 'title must exit' do
      user = User.new(name: 'bob', photo_link: 'url', bio: 'developer')
  ...
  describe '#update_likes_count' do
    it 'updates likes_counter based on the number of likes' do
      ...
      user.save
      post = Post.new(author_id: user.id, title: 'new title', text: 'This is my second post', comments_counter: 0,
                      likes_counter: 0)
      post.save
  ...
  describe '#recent_comments' do
    it 'returns the most recent 5 comments' do
      ...
      comment1 = Comment.new(user:, post:, text: 'Comment 1')
      comment1.save
